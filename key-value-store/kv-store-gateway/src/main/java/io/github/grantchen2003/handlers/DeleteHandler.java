...
public class DeleteHandler extends AbstractShardHandler {
    public DeleteHandler(ShardRouter router) {
        super(router);
    }
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        final URI shardUri = URI.create("http://" + shardIp + "/delete?key=" + encodedKey);
        ...
        try {
            ...
            System.out.println("DELETE " + request.uri() + " | Response: " + response.statusCode());
